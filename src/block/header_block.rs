...
/// The block with ID equal to 0 is a special block designated as the "header block", which
...
/// header block. The header block is always pinned to the buffer pool while the database is
/// running.
///
